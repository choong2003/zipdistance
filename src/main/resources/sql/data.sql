...
-- Insert sample users pass#hashed_password1,hashed_password2,hashed_password3
...
INSERT INTO permissions (name) VALUES ('CREATE_USER'),('UPDATE_USER'), ('CREATE_POSTAL'), ('UPDATE_POSTAL'), ('VIEW_POSTAL');

-- Admin has all permissions
INSERT INTO role_permissions (role_id, permission_id) VALUES
(1, 1), (1, 2), (1, 3), (1, 4), (1, 5);

-- Normal User has view POSTAL only
INSERT INTO role_permissions (role_id, permission_id) VALUES
(2, 5);
